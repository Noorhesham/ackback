...
const FormSelect = ({ name, label, placeholder, description, id, options, selected, className, optional }: any) => {
  ...
  return (
    <FormField
      ...
      render={({ field }) => {
        ...
        return (
          <FormItem className={`${className || ""} items-start relative w-full `} id={id || ""}>
            <FormLabel className=" relative w-fit  ml-auto capitalize">
              {" "}
